...
const Add = () => {
    ...
    return (
        <div className=" max-w-4xl ma-auto mt-10 bg-white p-8 riunded-md shadow-md">
            ...
            <form onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <label className="block text-sm font-medium text-gray-700">
                        ...
                        <input type="file" onChange={handleChange} name="image" placeholder="Image Upload" accept="image/*" className="mt-1 p-2 block w-full border border-gray-300 rounded-md "  required />
                    </div>
                </div>
