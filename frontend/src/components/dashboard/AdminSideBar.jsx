...
import { FaBuilding, FaCalendar, FaCogs, FaMedkit, FaMoneyBillWave, FaRegCalendarAlt, FaTachometerAlt, FaUsers} from 'react-icons/fa'
    ...
    return (
        <div className='bg-gray-800 text-white h-screen fixed left-0 top-0 bottom-0 space-y-2 w-64'>
            ...
            <div className='px-4'>
                ...
                <NavLink to="/admin-dashboard/department-heads"
                    className={({ isActive })=>`${isActive ? "bg-teal-500 " : " "} flex items-center space-x-4 block py-2.5 px-4 rounded`}>
                    <FaMedkit />
